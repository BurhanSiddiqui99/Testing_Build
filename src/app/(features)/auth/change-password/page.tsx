      ...
      <Col xxl={12} xl={12} lg={12} md={24} sm={24} xs={24}>
        <div className="min-h-screen w-full flex items-center justify-center bg-dot-pattern relative px-4">
          <div
            ...
            style={{backgroundImage: `url(${background.src})`,backgroundSize: "100% 100vh",}}
          />
          ...
          <Card className="w-full max-w-[500px] shadow-lg rounded-3xl px-8">
            <div className="text-center mb-6">
              ...
              <Paragraph type="secondary">Enter your new password and confirm password</Paragraph>
              <form className="mt-4 w-full" onSubmit={handleSubmit(changePasswordForm)}>
                <label className="font-semibold flex mb-2">New Password</label>
                <Controller
                  name="password"
                  control={control}
                  rules={{
                    ...
                    validate: (value) =>
                      value.toString().length !== 0 || "This field is required",
                  }}
                ...
                <label className="font-semibold flex mb-2">Confirm Password</label>
                <Controller
                ...
                />
                <button className="bg-gradient-to-r from-[#8052A0] to-[#55A0D7] w-full py-3 mt-4 rounded-lg text-white font-semibold" type="submit"> Update </button>
